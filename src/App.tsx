...
function App(): JSX.Element {
  return (
    ...
    />
        ...
        />
                <PictureBox
        imageLink= {"https://cdn5.tropicalsky.co.uk/images/800x600/coastline-around-vancouver-islands-pacific-rim-national-park-reserve.jpg"}
        imageTitle= {"Pacific Rim National Park Reserve, British Columbia"}
        country = {"Canada"}
        locale = {"British Columbia"}
        mapLink = {"https://www.google.com/maps?q=Pacific+Rim+National+Park+Reserve,+British+Columbia&um=1&ie=UTF-8&sa=X&ved=2ahUKEwiLrv_rmYD5AhWOasAKHXukCkAQ_AUoAXoECAIQAw"}
        imageCaption = {"A part of the nationl park with nice green forest and a bunch of mud and rocks in the back "}
        />
        <PageFooter
